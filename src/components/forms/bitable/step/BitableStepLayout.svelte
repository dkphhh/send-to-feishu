<script lang="ts">
	import Step from '@/components/layout/Step.svelte';
	import { BITABLE_STEP_TITLES, type BitableStep } from '@/lib/const';
...
<div class="flex w-full flex-col items-center justify-center gap-4">
	<Step stepList={BITABLE_STEP_TITLES} {currentStep} />
