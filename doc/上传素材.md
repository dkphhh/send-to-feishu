...
def upload_media():
    ...
    headers = {
        'Authorization': 'Bearer t-e13d5ec1954e82e458f3ce04491c54ea8c9abcef',  ## 获取 tenant_access_token, 需要替换为实际的 token
    }
...
400 | 1062008 | checksum param Invalid. | 请确保文件/文件块的 checksum 正确。
...
400 | 1062506 | parent node out of depth. | 云空间目录深度超限制（15 限制）。
